        ...
        foreach ($assignments as $form => $subjects) {
            foreach ($subjects as $subject) {
                echo "<tr>
                    <td>$form</td>
                    <td>$subject</td>
                    <td><button class='view-btn' onclick='viewStudents(\"$form\", \"$subject\")'>View Students</button></td>
                </tr>";
            }
        }
        ?>
...
function viewStudents(form, subject) {
    ...
    window.location.href = `teacher_view_students.php?form=${encodeURIComponent(form)}&subject=${encodeURIComponent(subject)}`;
}
</script>
